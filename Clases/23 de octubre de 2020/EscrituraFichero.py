...
def escribe(fichsal, itdatos):  # Si no se captura ninguna excepción, escribe itdatos en fichsal.
    try:
...
auxiliar2 = tuple(itertools.islice(auxiliar, 1, len(auxiliar)))
# Generador que contene por orden las líneas entre las primeras líneas "***".
